...
namespace LeetcodeProblems.BinarySearch.Tests
{
    [TestClass()]
    public class Problem1BinarySearchTests
    {
        [TestMethod()]
        public void Example1_Return_4()
        {
            Problem1BinarySearch solution = new Problem1BinarySearch();
            List<int> inputNums = new List<int>() { -1, 0, 3, 5, 9, 12 };
            int target = 9;
            Assert.AreEqual(4, solution.Search(inputNums.ToArray(), target));
        }

        [TestMethod()]
        public void Example2_Return_Negative1()
        {
            Problem1BinarySearch solution = new Problem1BinarySearch();
            List<int> inputNums = new List<int>() { -1, 0, 3, 5, 9, 12 };
            int target = 2;
            Assert.AreEqual(-1, solution.Search(inputNums.ToArray(), target));
        }
